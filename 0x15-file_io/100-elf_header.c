 ...
 * @header: pointer to an Elf64_Ehdr struct contains the header of an ELF file.
 */
 ...
 * @header:pointer to an Elf64_Ehdr struct that contains the header.
 */
void display_elf_header(Elf64_Ehdr *header)
{
	...
	printf("2's complement, little endian" : "2's complement, big endian");
	printf("Version");
